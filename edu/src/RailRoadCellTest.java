...
public class RailRoadCellTest extends TestCase {
	...
	public void testPlayerAction() {
		RailRoadCell cell = (RailRoadCell) gameMaster.getGameBoard().queryCell(
				"Railroad A");
	...
	public void testRent() {
		RailRoadCell rr1 = (RailRoadCell) gameMaster.getGameBoard().queryCell(
				"Railroad A");
		...
		RailRoadCell rr2 = (RailRoadCell) gameMaster.getGameBoard().queryCell(
				"Railroad B");
