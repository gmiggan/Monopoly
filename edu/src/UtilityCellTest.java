...
public class UtilityCellTest extends TestCase {
	...
	public void testPlayerAction() {
		UtilityCell cell = (UtilityCell) gameMaster.getGameBoard().queryCell(
				"Utility 1");
		...
		assertEquals(1500 - cell.getRent(diceRoll), gameMaster.getPlayer(1)
				.getMoney());
		assertEquals(1350 + cell.getRent(diceRoll), gameMaster.getPlayer(0)
				.getMoney());
	}
	...
	public void testRent() {
		UtilityCell u1 = (UtilityCell) gameMaster.getGameBoard().queryCell(
				"Utility 1");
		...
		UtilityCell u2 = (UtilityCell) gameMaster.getGameBoard().queryCell(
				"Utility 2");
